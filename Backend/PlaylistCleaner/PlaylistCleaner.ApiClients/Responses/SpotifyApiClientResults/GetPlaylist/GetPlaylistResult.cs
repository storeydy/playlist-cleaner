...
public sealed record GetPlaylistResult(bool collaborative, string description, GetPlaylistResultExternalUrls external_urls, string href, string id, ICollection<GetPlaylistResultImageObject> images, string name, GetPlaylistResultPlaylistOwner owner, bool Public, string snapshot_id, GetPlaylistResultTrack tracks, string type, string uri);
